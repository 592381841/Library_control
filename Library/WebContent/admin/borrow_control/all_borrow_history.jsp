...
function modfiyTime(){
	$.ajax({
        ...
        url:"<c:url value='/admin/borrow_contol/json_borrow_history_by_time.action'/>",
        async:true,
...
// 	alert($(athis).val());  
	$.ajax({
        ...
        url:"<c:url value='/admin/borrow_control/json_borrow_history_by_type.action'/>",
        async:true,
        success:function (data){
        	load_list(data);
        }
...
$.ajax({
          ...
          cache: false,
          type: "POST",
          url:"<c:url value='/admin/borrow_control/json_page_borrow_history.action'/>",
          data :{
          	"pageInfo.page" : page
          },
          async:true,
