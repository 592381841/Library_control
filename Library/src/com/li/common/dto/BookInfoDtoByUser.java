...
public class BookInfoDtoByUser {
	private Integer id;
	private BookTypeDto bookTypeDto;
	private boolean bookUnuse;
	private String collectInfo;
	public String getStackRoomName() {
		return stackRoomName;
	}
	public void setStackRoomName(String stackRoomName) {
		this.stackRoomName = stackRoomName;
	}
